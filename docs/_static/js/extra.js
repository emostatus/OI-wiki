...
function foo(response) {
  ...
  if (data && data[0]) {
    ...
    url += '/index';
    var script = document.createElement('script');
    document.getElementsByClassName('edit_history')[0].setAttribute('href', `https://github.com/emostatus/OI-wiki/commits/master/docs/${url}`);
    script.src = `https://api.github.com/repos/emostatus/OI-wiki/commits?path=docs/${url}&callback=foo`;
...
if (url == "/index.md") {
  // HomePage
  document.getElementsByClassName('edit_history')[0].setAttribute('href', `https://github.com/emostatus/OI-wiki/commits/master/docs/index.md`);
  script.src = `https://api.github.com/repos/emostatus/OI-wiki/commits?path=docs/index.md&callback=foo`;
  document.getElementsByTagName('head')[0].appendChild(script);
  ...
  document.getElementsByClassName('edit_history')[0].setAttribute('href', `https://github.com/emostatus/OI-wiki/commits/master`);
